...
urlpatterns = [
    ...
    path(
        "response_ticket/<int:ticket_id>/",
        flux.views.response_ticket,
        name="response_ticket",
    ),
    path("ticket_review", flux.views.ticket_review, name="ticket_review"),
    path(
        "delete_ticket/<int:ticket_id>/", flux.views.delete_ticket, name="delete_ticket"
    ),
    path(
        "delete_review/<int:review_id>/", flux.views.delete_review, name="delete_review"
    ),
